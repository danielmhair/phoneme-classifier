# Spike 001: Minimal Streaming Wav2Vec2 -> CTC Pipeline
...
```bash
python -m w2v2-ctc_workflow.stream_wav2vec2_ctc_spike --wav path/to/audio.wav \  --phoneme_vocab tokenizer/phoneme_vocab.txt \  --chunk_ms 40 --stride_ms 20 --stabilization_repeats 2
```
