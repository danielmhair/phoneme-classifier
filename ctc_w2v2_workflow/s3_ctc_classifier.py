    ...
    def evaluate(self, dataloader: DataLoader) -> Tuple[float, float]:
        ...
        with torch.no_grad():
            for batch in dataloader:
                ...
                predictions = self.model.predict(embeddings.mean(dim=2))
...
def train_ctc_model(
    ...
    """
    print(f"🚀 Starting CTC model training...")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_dir", type=str, default="dist/phoneme_embeddings",
                       help="Input directory containing embeddings")
    parser.add_argument("--output_dir", type=str, default="dist",
